...
class AuthState {
  ...
  bool looged;
  List<Card>? expenses;
  AuthState({this.token = '', this.userId = '', this.looged = false, this.expenses});
}

class AuthBloc extends Bloc<AuthEvent, AuthState> {

  AuthBloc(String email, String password) : super(AuthState(token: '', userId: '')) {
  ...
  Future<bool> GetExpenses() async {
    ...
    try {
      var expenseList = await httpHelper.GetAllExpesenses(this.state.userId, this.state.token);
